...
public class Robot extends TimedRobot {
    ...
    public void robotPeriodic() {
        ...
        // scheduled commands, removing finished or interrupted commands, and running subsystem periodic() methods. This
        // must be called from the robot's periodic block in order for anything in the Command-based framework to work.
        CommandScheduler.getInstance().run();
        // display robot orientation for balancing testing
        SmartDashboard.putNumber("roll", DriveTrain.gyro.getRoll());
    }
